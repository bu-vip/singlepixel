...
java_library(
    ...
    exports = [
        "@org_ejml_all//jar",
        "@org_ejml_core//jar",
        "@org_ejml_dense64//jar",
        "@org_ejml_denseC64//jar",
        "@org_ejml_equation//jar",
        "@org_ejml_simple//jar",
    ],
)
...
java_library(
    ...
    exports = [
        ...
        "@io_ratpack_ratpack_core//jar",
        "@io_ratpack_ratpack_guice//jar",
        "@javax_inject_javax_inject//jar",
...
java_library(
    ...
    visibility = ["//visibility:public"],
    exports = [
        "@org_eclipse_paho_org_eclipse_paho_client_mqttv3//jar",
    ],
)
